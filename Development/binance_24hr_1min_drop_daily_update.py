...
# updat symbol list
# save latest 24 hr drop data for all symbols
...
# save latest 24 hr data for all symbols
...
for s in symbols_filtered:
    ...
    symbol_candles_path = './binance_training_data/'+ day_folder + '/'+ s +'_data_'+str(minutes)+'m.pklz'
