...
def trade_on_drops(symbol, data, buy_trigger_drop_percent, sell_trigger_gain_percent, btc_tradeable_volume_factor):
    s = symbol['symbol']
...
for d, day in enumerate(days):
    ...
    for s in symbols_filtered:
        ...
        if data_1 == False or len(data_1) < 30:
            ...
            # gain_percent, gain_usd, trades = trade_on_drops(symbol, data_1, buy_trigger_drop_percent, sell_trigger_gain_percent, btc_tradeable_volume_factor)
            ...
            if data_2 == False or len(data_2) < 30:
                ...
                gain_percent, gain_usd, trades = trade_on_drops(symbol, data_2, buy_trigger_drop_percent, sell_trigger_gain_percent, btc_tradeable_volume_factor)
                if print_trades:
