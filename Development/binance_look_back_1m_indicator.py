...
# INDICATOR BOT #
ut.pickle_write('/home/ec2-user/environment/botfarming/Development/variables/indicator_trades_1m', [])
indicator_bot = 1
file_number = 0
total_files = 1
length = '1m'
ut.pickle_write('/home/ec2-user/environment/botfarming/Development/variables/stop_trading_until_'+length,int(time.time())+1*2*60)
