...
# INDICATOR BOT #
ut.pickle_write('/home/ec2-user/environment/botfarming/Development/variables/indicator_trades_2h', [])
indicator_bot = 1
file_number = 0
total_files = 1
length = '2h'
ut.pickle_write('/home/ec2-user/environment/botfarming/Development/variables/stop_trading_until_'+length,int(time.time())+2*60*2*60)
