...
# INDICATOR BOT #
ut.pickle_write('/home/ec2-user/environment/botfarming/Development/variables/indicator_trades_5m', [])
indicator_bot = 1
file_number = 0
total_files = 1
length = '5m'
ut.pickle_write('/home/ec2-user/environment/botfarming/Development/variables/stop_trading_until_'+length,int(time.time())+5*2*60)
