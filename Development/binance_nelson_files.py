...
# f = gzip.open('./binance_data/'+ symbol +'_data_30m.pklz','rb')
# data = pickle.load(f)
# f.close()

# f = gzip.open('./binance_data/'+ symbol +'_data_30m_p0.pklz','rb')
# data1 = pickle.load(f)
# f.close()

# f = gzip.open('./binance_data/'+ symbol +'_data_30m_p1.pklz','rb')
# data2 = pickle.load(f)
# f.close()
