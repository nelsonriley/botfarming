    ...
    while True:
        ...
        for s in symbols_trimmed:
            ...
            for look_back in optimizing_array:
                ...
                price_to_buy_factor_array[look_back] = max_price_to_buy_factor - default_change_size_2*40
                ...
                minutes_until_sale_array[look_back] = minutes_until_sale
            ...
            for optimizing in optimizing_array:
                ...
                for iteration in range(-1,6):
                    ...
                    if iteration == 0:
                        a_range = 41
                        b_range = 1
                        change_size = default_change_size_1
                        ...
                        b_range = 41
                        change_size = default_change_size_1
                        starting_sell_factor =  optimal_buy_factor
                    elif iteration == 3:
                        a_range = 1
                        b_range = 5
                        change_size = default_change_size_2
                    ...
                    for a in range(0, a_range):
                        ...
                        for b in range(0, b_range):
                            ...
                            if price_to_sell_factor_array[optimizing] > .99:
                                continue
