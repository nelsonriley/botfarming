    ...
    for a in range(0, 1):
        for b in range(0, 1):
            ...
            for s in symbols_trimmed:
                ...
                data = ut.pickle_read('/home/ec2-user/environment/botfarming/Development/binance_training_data/'+ day + '/'+ symbol['symbol'] +'_data_'+str(1)+'m_p'+str(step_back)+'.pklz')
                    ...
                    if index > datapoints_trailing and float(candle[3]) < float(data[index][1])*price_to_buy_factor:
                        ...
                        if will_buy:
                            ...
                            if minutes > 1:
                                ...
                                sale_data_path = '/home/ec2-user/environment/botfarming/Development/binance_training_data/'+ day + '/sale_data_' + str(minutes) + 'm_'+ symbol['symbol'] +'_start_' + str(start_time_period) + '_end_' + str(end_time_period) +'.pklz'
