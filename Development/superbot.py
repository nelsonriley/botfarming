...
for s in symbols_trimmed:
    ...
    # state_path = '/home/ec2-user/environment/botfarming/Development/program_state_1m/program_state_1m_1000_' + s + '.pklz'
...
#             order_book_path = '/home/ec2-user/environment/botfarming/Development/recent_order_book/'+s+'.pklz'
#             order_book = ut.pickle_read(order_book_path)
#             if order_book != False:
#                 current_price = float(order_book['bids'][0][0])
#                 candles_path = '/home/ec2-user/environment/botfarming/Development/recent_klines/'+s+'_1m.pklz'
