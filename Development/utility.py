...
def buy_coin(symbol, length, file_number, data=[]):
    ...
    try:
        ...
        lower_band_buy_factor_array = [0,1.04, 200, 200, 200, 200, 200, 200, 200, 200, 200]
        price_to_buy_factor_array = [0,.985, .986, .986, .982, .982, .985, .982, .985, .985, .958]
        datapoints_trailing = 23

        minutes_until_sale = 4
        minutes_until_sale_2 = 12
        minutes_until_sale_3 = 45
        price_to_sell_factor_array = [0,.997, .998, .998, .998, 1.001, .998, 1.001, .998, .999, .988]
