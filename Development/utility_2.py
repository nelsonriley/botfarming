...
def run_24hr_1min_drop_strategy(bot_index=-1, total_bots=-1):
    print('starting 24hr_1min_drop_strategy', ut.get_time())
    print_computer_ip()
    min_volume_btc = 0
...
def monitor_and_buy_for_24hr_1min_drop(symbol, interval, file_number):
    ...
    current_state_path = './botfarming/Development/program_state_' + interval + '/program_state_' + interval + '_' + str(file_number) + '_' + s + '.pklz'
    ...
    try:
        ...
        buy_trigger_drop_percent_factor = 0.8 # starter faster   0.166 trades / min
        sell_trigger_gain_percent_factor = 0.9 # starter faster
        future_candles_length = 15 # 20180205

        # DATA generated from previous 24 hours via cron
        ...
        if isinstance(data, basestring):
            print('API request for candles failed, exiting', symbol['symbol'])
            return
        ...
        while time.localtime().tm_sec < 1 or time.localtime().tm_sec >= 3:
            ...
            if current_price == False:
                print('DATA DELAYED: no ticker data found for', s, ut.get_time())
                break
            ...
            if drop_percent >= buy_trigger_drop_percent:
                ...
                largest_bitcoin_order = part_of_bitcoin_to_use # aka "part_of_bitcoin_to_use_per_order" 0.1 # part_of_bitcoin_to_use * 0.1
    ...
    for settings in save_params:
        ...
        if start_end_style:
            ...
            for symbol in coins:
                ...
                #     pprint(data[-1])
                #     print('--------------------ETHBTC')
                candle_path = './botfarming/Development/binance_training_data/'+ day_folder + '/'+ symbol +'_data_'+str(minutes)+'m.pklz'
