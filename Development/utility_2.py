...
def monitor_and_buy_for_24hr_1min_drop(symbol, interval, file_number, client):
    ...
    try:
        ...
        buy_trigger_drop_percent_factor = 0.7
        sell_trigger_gain_percent_factor = 0.6
        ...
        # get open price in first 3 secs of minute
        ...
        # run for the remaing 57 seconds of the minute
        while time.localtime().tm_sec >= 3 and have_open_price:

            current_price = get_current_price_from_ticker(s)
            if current_price == False:
                print('DATA DELAYED OR MISSING: no ticker data for', s, ut.get_time())
                break
