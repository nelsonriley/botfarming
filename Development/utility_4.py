...
def buy_coin(symbol, length, file_number):
    ...
    try:
        ...
        for look_back in look_back_schedule:
            ...
            look_back_optimized = pickle_read('/home/ec2-user/environment/botfarming/Development/optimization_factors/VLong_optimal_for_' + symbol['symbol'] + '_' + str(look_back) + '.pklz')
